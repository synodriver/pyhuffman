...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "pyhuffman.backends.cython._hfm",
        "sources": [
            "pyhuffman/backends/cython/_hfm.pyx",
            "./huffman/huffman.c"
        ]
    },
    "module_name": "pyhuffman.backends.cython._hfm"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyhuffman__backends__cython___hfm
#define __PYX_HAVE_API__pyhuffman__backends__cython___hfm
/* Early includes */
#include <string.h>
#include <stdio.h>
#include <stdint.h>
...
/* Module declarations from 'pyhuffman.backends.cython.huffman' */

/* Module declarations from 'pyhuffman.backends.cython._hfm' */
...
static PyObject *__pyx_f_9pyhuffman_8backends_6cython_4_hfm_ensure_bytes(PyObject *); /*proto*/
static CYTHON_INLINE int __pyx_f_9pyhuffman_8backends_6cython_4_hfm_encode_file(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE int __pyx_f_9pyhuffman_8backends_6cython_4_hfm_decode_file(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pyhuffman_8backends_6cython_4_hfm_encode(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pyhuffman_8backends_6cython_4_hfm_decode(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pyhuffman.backends.cython._hfm"
extern int __pyx_module_is_main_pyhuffman__backends__cython___hfm;
int __pyx_module_is_main_pyhuffman__backends__cython___hfm = 0;

/* Implementation of 'pyhuffman.backends.cython._hfm' */
...
static PyObject *__pyx_kp_u_can_not_open;
...
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_encode_file(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_in_, PyObject *__pyx_v_out_); /* proto */
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_2decode_file(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_in_, PyObject *__pyx_v_out_); /* proto */
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_4encode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data); /* proto */
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_6decode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data); /* proto */
...
/* "pyhuffman/backends/cython/_hfm.pyx":19
 * 
 * 
...
static PyObject *__pyx_f_9pyhuffman_8backends_6cython_4_hfm_ensure_bytes(PyObject *__pyx_v_file) {
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":20
 * 
 * cdef bytes ensure_bytes(object file):
 *     if isinstance(file, Path):             # <<<<<<<<<<<<<<
 *         return str(file).encode()
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":21
 * cdef bytes ensure_bytes(object file):
 *     if isinstance(file, Path):
 *         return str(file).encode()             # <<<<<<<<<<<<<<
 *     elif isinstance(file, str):
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":22
 *     if isinstance(file, Path):
 *         return str(file).encode()
 *     elif isinstance(file, str):             # <<<<<<<<<<<<<<
 *         return file.encode()
 *     else:
 */
  __pyx_t_3 = PyUnicode_Check(__pyx_v_file); 
  __pyx_t_2 = (__pyx_t_3 != 0);
  if (__pyx_t_2) {

    /* "pyhuffman/backends/cython/_hfm.pyx":23
 *         return str(file).encode()
 *     elif isinstance(file, str):
 *         return file.encode()             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":25
 *         return file.encode()
 *     else:
 *         return bytes(file)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.ensure_bytes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "pyhuffman/backends/cython/_hfm.pyx":27
 *         return bytes(file)
 * 
 * cpdef inline int encode_file(object in_, object out_) except +:             # <<<<<<<<<<<<<<
 *     cdef:
...
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_1encode_file(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE int __pyx_f_9pyhuffman_8backends_6cython_4_hfm_encode_file(PyObject *__pyx_v_in_, PyObject *__pyx_v_out_, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_use_fopen;
  FILE *__pyx_v_in_file;
  FILE *__pyx_v_out_file;
  PyObject *__pyx_v_in_name_bytes = NULL;
  PyObject *__pyx_v_out_name_bytes = NULL;
  int __pyx_v_ret;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":29
 * cpdef inline int encode_file(object in_, object out_) except +:
 *     cdef:
 *         int use_fopen = 0             # <<<<<<<<<<<<<<
 *         FILE * in_file
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":32
 *         FILE * in_file
 *         FILE * out_file
 ...
 */
  __pyx_t_2 = (PyObject_HasAttrString(__pyx_v_in_, ((char const *)"fileno")) != 0);
  if (__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = (PyObject_HasAttrString(__pyx_v_out_, ((char const *)"fileno")) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_1) {

    /* "pyhuffman/backends/cython/_hfm.pyx":33
 *         FILE * out_file
 *     if PyObject_HasAttrString(in_, "fileno") and PyObject_HasAttrString(out_, "fileno"):
 *         in_file = fdopen(os.dup(in_.fileno()), "rb")             # <<<<<<<<<<<<<<
 *         out_file = fdopen(os.dup(out_.fileno()), "wb")
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":34
 *     if PyObject_HasAttrString(in_, "fileno") and PyObject_HasAttrString(out_, "fileno"):
 *         in_file = fdopen(os.dup(in_.fileno()), "rb")
 *         out_file = fdopen(os.dup(out_.fileno()), "wb")             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":36
 *         out_file = fdopen(os.dup(out_.fileno()), "wb")
 *     else:
 *         use_fopen = 1             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":37
 *     else:
 *         use_fopen = 1
 *         in_name_bytes = ensure_bytes(in_)             # <<<<<<<<<<<<<<
 *         out_name_bytes = ensure_bytes(out_)
 ...
 */
    __pyx_t_3 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_ensure_bytes(__pyx_v_in_); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_v_in_name_bytes = ((PyObject*)__pyx_t_3);
    __pyx_t_3 = 0;

    /* "pyhuffman/backends/cython/_hfm.pyx":38
 *         use_fopen = 1
 *         in_name_bytes = ensure_bytes(in_)
 *         out_name_bytes = ensure_bytes(out_)             # <<<<<<<<<<<<<<
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 *         if in_file == NULL:
 */
    __pyx_t_3 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_ensure_bytes(__pyx_v_out_); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 38, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_v_out_name_bytes = ((PyObject*)__pyx_t_3);
    __pyx_t_3 = 0;

    /* "pyhuffman/backends/cython/_hfm.pyx":39
 *         in_name_bytes = ensure_bytes(in_)
 *         out_name_bytes = ensure_bytes(out_)
 *         in_file = fopen(<char*>in_name_bytes, "rb")             # <<<<<<<<<<<<<<
 *         if in_file == NULL:
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":40
 *         out_name_bytes = ensure_bytes(out_)
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 *         if in_file == NULL:             # <<<<<<<<<<<<<<
 *             raise FileNotFoundError(f"can not open{in_}")
 ...
 */
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "pyhuffman/backends/cython/_hfm.pyx":41
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 *         if in_file == NULL:
 *             raise FileNotFoundError(f"can not open{in_}")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyObject_FormatSimple(__pyx_v_in_, __pyx_empty_unicode); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_PyUnicode_Concat(__pyx_kp_u_can_not_open, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":43
 *             raise FileNotFoundError(f"can not open{in_}")
 * 
 *         out_file = fopen(<char *> out_name_bytes, "wb")             # <<<<<<<<<<<<<<
 *         if out_file == NULL:
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":44
 * 
 *         out_file = fopen(<char *> out_name_bytes, "wb")
 *         if out_file == NULL:             # <<<<<<<<<<<<<<
 *             fclose(in_file)
 ...
 */
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "pyhuffman/backends/cython/_hfm.pyx":45
 *         out_file = fopen(<char *> out_name_bytes, "wb")
 *         if out_file == NULL:
 *             fclose(in_file)             # <<<<<<<<<<<<<<
 *             raise FileNotFoundError(f"can not open{out_}")
 ...
 */
      ...
      /* "pyhuffman/backends/cython/_hfm.pyx":46
 *         if out_file == NULL:
 *             fclose(in_file)
 *             raise FileNotFoundError(f"can not open{out_}")             # <<<<<<<<<<<<<<
 *     cdef int ret
 *     with nogil:
 */
      __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_FileNotFoundError); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_PyObject_FormatSimple(__pyx_v_out_, __pyx_empty_unicode); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_3 = __Pyx_PyUnicode_Concat(__pyx_kp_u_can_not_open, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":48
 *             raise FileNotFoundError(f"can not open{out_}")
 *     cdef int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pyhuffman/backends/cython/_hfm.pyx":49
 *     cdef int ret
 *     with nogil:
 *         ret = huffman_encode_file(in_file, out_file)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":51
 *         ret = huffman_encode_file(in_file, out_file)
 * 
 *     if use_fopen:             # <<<<<<<<<<<<<<
 *         fclose(in_file)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":52
 * 
 *     if use_fopen:
 *         fclose(in_file)             # <<<<<<<<<<<<<<
 *         fclose(out_file)
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":53
 *     if use_fopen:
 *         fclose(in_file)
 *         fclose(out_file)             # <<<<<<<<<<<<<<
 *     if ret > 0:
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":54
 *         fclose(in_file)
 *         fclose(out_file)
 *     if ret > 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":55
 *         fclose(out_file)
 *     if ret > 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":56
 *     if ret > 0:
 *         raise ValueError
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.encode_file", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_in_name_bytes);
  __Pyx_XDECREF(__pyx_v_out_name_bytes);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_1encode_file(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_encode_file[] = "encode_file(in_, out_) -> int";
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_1encode_file(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_in_ = 0;
  PyObject *__pyx_v_out_ = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_in,&__pyx_n_s_out,0};
  ...
  __pyx_r = __pyx_pf_9pyhuffman_8backends_6cython_4_hfm_encode_file(__pyx_self, __pyx_v_in_, __pyx_v_out_);
...
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_encode_file(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_in_, PyObject *__pyx_v_out_) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  __Pyx_XDECREF(__pyx_r);
  try {
    __pyx_t_1 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_encode_file(__pyx_v_in_, __pyx_v_out_, 0);
  } catch(...) {
    __Pyx_CppExn2PyErr();
...
/* "pyhuffman/backends/cython/_hfm.pyx":58
 *     return ret
 * 
 * cpdef inline int decode_file(object in_, object out_) except +:             # <<<<<<<<<<<<<<
 *     cdef:
...
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_3decode_file(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE int __pyx_f_9pyhuffman_8backends_6cython_4_hfm_decode_file(PyObject *__pyx_v_in_, PyObject *__pyx_v_out_, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_use_fopen;
  FILE *__pyx_v_in_file;
  FILE *__pyx_v_out_file;
  PyObject *__pyx_v_in_name_bytes = NULL;
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":60
 * cpdef inline int decode_file(object in_, object out_) except +:
 *     cdef:
 *         int use_fopen = 0             # <<<<<<<<<<<<<<
 *         FILE * in_file
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":63
 *         FILE * in_file
 *         FILE * out_file
 *     if PyObject_HasAttrString(in_, "fileno") and PyObject_HasAttrString(out_, "fileno"):             # <<<<<<<<<<<<<<
 *         in_file = fdopen(os.dup(in_.fileno()), "rb")
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":64
 *         FILE * out_file
 *     if PyObject_HasAttrString(in_, "fileno") and PyObject_HasAttrString(out_, "fileno"):
 *         in_file = fdopen(os.dup(in_.fileno()), "rb")             # <<<<<<<<<<<<<<
 *         out_file = fdopen(os.dup(out_.fileno()), "wb")
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_dup); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_v_in_, __pyx_n_s_fileno); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_6))) {
      __pyx_t_7 = PyMethod_GET_SELF(__pyx_t_6);
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":65
 *     if PyObject_HasAttrString(in_, "fileno") and PyObject_HasAttrString(out_, "fileno"):
 *         in_file = fdopen(os.dup(in_.fileno()), "rb")
 *         out_file = fdopen(os.dup(out_.fileno()), "wb")             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_dup); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_v_out_, __pyx_n_s_fileno); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_6))) {
      __pyx_t_7 = PyMethod_GET_SELF(__pyx_t_6);
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_out_file = fdopen(__pyx_t_8, ((char const *)"wb"));
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":67
 *         out_file = fdopen(os.dup(out_.fileno()), "wb")
 *     else:
 *         use_fopen = 1             # <<<<<<<<<<<<<<
 *         in_name_bytes = ensure_bytes(in_)
 ...
 */
  /*else*/ {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":68
 *     else:
 *         use_fopen = 1
 *         in_name_bytes = ensure_bytes(in_)             # <<<<<<<<<<<<<<
 *         out_name_bytes = ensure_bytes(out_)
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 */
    __pyx_t_3 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_ensure_bytes(__pyx_v_in_); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_v_in_name_bytes = ((PyObject*)__pyx_t_3);
    __pyx_t_3 = 0;

    /* "pyhuffman/backends/cython/_hfm.pyx":69
 *         use_fopen = 1
 *         in_name_bytes = ensure_bytes(in_)
 *         out_name_bytes = ensure_bytes(out_)             # <<<<<<<<<<<<<<
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 *         if in_file == NULL:
 */
    __pyx_t_3 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_ensure_bytes(__pyx_v_out_); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_v_out_name_bytes = ((PyObject*)__pyx_t_3);
    __pyx_t_3 = 0;

    /* "pyhuffman/backends/cython/_hfm.pyx":70
 *         in_name_bytes = ensure_bytes(in_)
 *         out_name_bytes = ensure_bytes(out_)
 *         in_file = fopen(<char*>in_name_bytes, "rb")             # <<<<<<<<<<<<<<
 *         if in_file == NULL:
 ...
 */
    ...
    __pyx_t_9 = __Pyx_PyBytes_AsWritableString(__pyx_v_in_name_bytes); if (unlikely((!__pyx_t_9) && PyErr_Occurred())) __PYX_ERR(0, 70, __pyx_L1_error)
    __pyx_v_in_file = fopen(((char *)__pyx_t_9), ((char const *)"rb"));

    /* "pyhuffman/backends/cython/_hfm.pyx":71
 *         out_name_bytes = ensure_bytes(out_)
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 *         if in_file == NULL:             # <<<<<<<<<<<<<<
 *             raise FileNotFoundError(f"can not open{in_}")
 ...
 */
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "pyhuffman/backends/cython/_hfm.pyx":72
 *         in_file = fopen(<char*>in_name_bytes, "rb")
 *         if in_file == NULL:
 *             raise FileNotFoundError(f"can not open{in_}")             # <<<<<<<<<<<<<<
 * 
 *         out_file = fopen(<char *> out_name_bytes, "wb")
 */
      __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_FileNotFoundError); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyObject_FormatSimple(__pyx_v_in_, __pyx_empty_unicode); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_PyUnicode_Concat(__pyx_kp_u_can_not_open, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_Raise(__pyx_t_4, 0, 0, 0);
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":74
 *             raise FileNotFoundError(f"can not open{in_}")
 * 
 *         out_file = fopen(<char *> out_name_bytes, "wb")             # <<<<<<<<<<<<<<
 *         if out_file == NULL:
 ...
 */
    ...
    __pyx_t_9 = __Pyx_PyBytes_AsWritableString(__pyx_v_out_name_bytes); if (unlikely((!__pyx_t_9) && PyErr_Occurred())) __PYX_ERR(0, 74, __pyx_L1_error)
    __pyx_v_out_file = fopen(((char *)__pyx_t_9), ((char const *)"wb"));

    /* "pyhuffman/backends/cython/_hfm.pyx":75
 * 
 *         out_file = fopen(<char *> out_name_bytes, "wb")
 *         if out_file == NULL:             # <<<<<<<<<<<<<<
 *             fclose(in_file)
 ...
 */
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "pyhuffman/backends/cython/_hfm.pyx":76
 *         out_file = fopen(<char *> out_name_bytes, "wb")
 *         if out_file == NULL:
 *             fclose(in_file)             # <<<<<<<<<<<<<<
 *             raise FileNotFoundError(f"can not open{out_}")
 ...
 */
      ...
      /* "pyhuffman/backends/cython/_hfm.pyx":77
 *         if out_file == NULL:
 *             fclose(in_file)
 *             raise FileNotFoundError(f"can not open{out_}")             # <<<<<<<<<<<<<<
 *     cdef int ret
 *     with nogil:
 */
      __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_FileNotFoundError); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 77, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_PyObject_FormatSimple(__pyx_v_out_, __pyx_empty_unicode); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 77, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_3 = __Pyx_PyUnicode_Concat(__pyx_kp_u_can_not_open, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 77, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_Raise(__pyx_t_5, 0, 0, 0);
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":79
 *             raise FileNotFoundError(f"can not open{out_}")
 *     cdef int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pyhuffman/backends/cython/_hfm.pyx":80
 *     cdef int ret
 *     with nogil:
 *         ret = huffman_decode_file(in_file, out_file)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":82
 *         ret = huffman_decode_file(in_file, out_file)
 * 
 *     if use_fopen:             # <<<<<<<<<<<<<<
 *         fclose(in_file)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":83
 * 
 *     if use_fopen:
 *         fclose(in_file)             # <<<<<<<<<<<<<<
 *         fclose(out_file)
 ...
 */
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":84
 *     if use_fopen:
 *         fclose(in_file)
 *         fclose(out_file)             # <<<<<<<<<<<<<<
 *     if ret > 0:
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":85
 *         fclose(in_file)
 *         fclose(out_file)
 *     if ret > 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":86
 *         fclose(out_file)
 *     if ret > 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":87
 *     if ret > 0:
 *         raise ValueError
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_XDECREF(__pyx_t_7);
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.decode_file", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_in_name_bytes);
  __Pyx_XDECREF(__pyx_v_out_name_bytes);
...
/* Python wrapper */
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_3decode_file(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_2decode_file[] = "decode_file(in_, out_) -> int";
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_3decode_file(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_in_ = 0;
  PyObject *__pyx_v_out_ = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("decode_file", 1, 2, 2, 1); __PYX_ERR(0, 58, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decode_file") < 0)) __PYX_ERR(0, 58, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decode_file", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 58, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.decode_file", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pyhuffman_8backends_6cython_4_hfm_2decode_file(__pyx_self, __pyx_v_in_, __pyx_v_out_);
...
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_2decode_file(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_in_, PyObject *__pyx_v_out_) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  __Pyx_XDECREF(__pyx_r);
  try {
    __pyx_t_1 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_decode_file(__pyx_v_in_, __pyx_v_out_, 0);
  } catch(...) {
    __Pyx_CppExn2PyErr();
...
/* "pyhuffman/backends/cython/_hfm.pyx":89
 *     return ret
 * 
 * cpdef inline bytes encode(const uint8_t[::1] data):             # <<<<<<<<<<<<<<
 *     cdef:
...
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_5encode(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pyhuffman_8backends_6cython_4_hfm_encode(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_input_size;
  unsigned char *__pyx_v_out_buf;
  uint32_t __pyx_v_out_len;
  int __pyx_v_ret;
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":91
 * cpdef inline bytes encode(const uint8_t[::1] data):
 *     cdef:
 *         Py_ssize_t input_size = data.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":92
 *     cdef:
 *         Py_ssize_t input_size = data.shape[0]
 *         unsigned char * out_buf = NULL             # <<<<<<<<<<<<<<
 *         uint32_t out_len
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":95
 *         uint32_t out_len
 *         int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pyhuffman/backends/cython/_hfm.pyx":96
 *         int ret
 *     with nogil:
 *         ret = huffman_encode_memory(<const unsigned char*>&data[0], <uint32_t>input_size, &out_buf, &out_len)             # <<<<<<<<<<<<<<
 *     assert out_buf != NULL
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":97
 *     with nogil:
 *         ret = huffman_encode_memory(<const unsigned char*>&data[0], <uint32_t>input_size, &out_buf, &out_len)
 *     assert out_buf != NULL             # <<<<<<<<<<<<<<
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":98
 *         ret = huffman_encode_memory(<const unsigned char*>&data[0], <uint32_t>input_size, &out_buf, &out_len)
 *     assert out_buf != NULL
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)             # <<<<<<<<<<<<<<
 *     PyMem_Free(out_buf)
 *     if ret > 0:
 */
  __pyx_t_2 = PyBytes_FromStringAndSize(((char *)__pyx_v_out_buf), ((Py_ssize_t)__pyx_v_out_len)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_out = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pyhuffman/backends/cython/_hfm.pyx":99
 *     assert out_buf != NULL
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)
 *     PyMem_Free(out_buf)             # <<<<<<<<<<<<<<
 *     if ret > 0:
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":100
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)
 *     PyMem_Free(out_buf)
 *     if ret > 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":101
 *     PyMem_Free(out_buf)
 *     if ret > 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return out
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":102
 *     if ret > 0:
 *         raise ValueError
 *     return out             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.encode", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_5encode(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static char __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_4encode[] = "encode(const uint8_t[::1] data) -> bytes";
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_5encode(PyObject *__pyx_self, PyObject *__pyx_arg_data) {
  ...
  assert(__pyx_arg_data); {
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(__pyx_arg_data, 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 89, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.encode", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pyhuffman_8backends_6cython_4_hfm_4encode(__pyx_self, __pyx_v_data);
...
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_4encode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_t_1 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_encode(__pyx_v_data, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyhuffman/backends/cython/_hfm.pyx":104
 *     return out
 * 
 * cpdef inline bytes decode(const uint8_t[::1] data):             # <<<<<<<<<<<<<<
 *     cdef:
...
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_7decode(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pyhuffman_8backends_6cython_4_hfm_decode(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_input_size;
  unsigned char *__pyx_v_out_buf;
  uint32_t __pyx_v_out_len;
  int __pyx_v_ret;
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":106
 * cpdef inline bytes decode(const uint8_t[::1] data):
 *     cdef:
 *         Py_ssize_t input_size = data.shape[0]             # <<<<<<<<<<<<<<
 *         unsigned char * out_buf = NULL
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":107
 *     cdef:
 *         Py_ssize_t input_size = data.shape[0]
 *         unsigned char * out_buf = NULL             # <<<<<<<<<<<<<<
 *         uint32_t out_len
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":110
 *         uint32_t out_len
 *         int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pyhuffman/backends/cython/_hfm.pyx":111
 *         int ret
 *     with nogil:
 *         ret = huffman_decode_memory(<const unsigned char*>&data[0], <uint32_t>input_size, &out_buf, &out_len)             # <<<<<<<<<<<<<<
 *     assert out_buf != NULL
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":112
 *     with nogil:
 *         ret = huffman_decode_memory(<const unsigned char*>&data[0], <uint32_t>input_size, &out_buf, &out_len)
 *     assert out_buf != NULL             # <<<<<<<<<<<<<<
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":113
 *         ret = huffman_decode_memory(<const unsigned char*>&data[0], <uint32_t>input_size, &out_buf, &out_len)
 *     assert out_buf != NULL
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)             # <<<<<<<<<<<<<<
 *     PyMem_Free(out_buf)
 *     if ret > 0:
 */
  __pyx_t_2 = PyBytes_FromStringAndSize(((char *)__pyx_v_out_buf), ((Py_ssize_t)__pyx_v_out_len)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 113, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_out = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pyhuffman/backends/cython/_hfm.pyx":114
 *     assert out_buf != NULL
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)
 *     PyMem_Free(out_buf)             # <<<<<<<<<<<<<<
 *     if ret > 0:
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":115
 *     cdef bytes out = PyBytes_FromStringAndSize(<char *>out_buf, <Py_ssize_t>out_len)
 *     PyMem_Free(out_buf)
 *     if ret > 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "pyhuffman/backends/cython/_hfm.pyx":116
 *     PyMem_Free(out_buf)
 *     if ret > 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return out
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":117
 *     if ret > 0:
 *         raise ValueError
 *     return out             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.decode", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_out);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_7decode(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static char __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_6decode[] = "decode(const uint8_t[::1] data) -> bytes";
static PyObject *__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_7decode(PyObject *__pyx_self, PyObject *__pyx_arg_data) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_data); {
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(__pyx_arg_data, 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 104, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyhuffman.backends.cython._hfm.decode", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pyhuffman_8backends_6cython_4_hfm_6decode(__pyx_self, __pyx_v_data);
...
static PyObject *__pyx_pf_9pyhuffman_8backends_6cython_4_hfm_6decode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("decode", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_data.memview)) { __Pyx_RaiseUnboundLocalError("data"); __PYX_ERR(0, 104, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9pyhuffman_8backends_6cython_4_hfm_decode(__pyx_v_data, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 104, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyhuffman.backends.cython._hfm.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyhuffman.backends.cython._hfm.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyhuffman.backends.cython._hfm.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyhuffman.backends.cython._hfm._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"encode_file", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_1encode_file, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_encode_file},
  {"decode_file", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_3decode_file, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_2decode_file},
  {"encode", (PyCFunction)__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_5encode, METH_O, __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_4encode},
  {"decode", (PyCFunction)__pyx_pw_9pyhuffman_8backends_6cython_4_hfm_7decode, METH_O, __pyx_doc_9pyhuffman_8backends_6cython_4_hfm_6decode},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__hfm(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__hfm},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_can_not_open, __pyx_k_can_not_open, sizeof(__pyx_k_can_not_open), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_hfm(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_hfm(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__hfm(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__hfm(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__hfm(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_hfm' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__hfm(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_hfm", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyhuffman__backends__cython___hfm) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyhuffman.backends.cython._hfm")) {
      if (unlikely(PyDict_SetItemString(modules, "pyhuffman.backends.cython._hfm", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":15
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":16
 * 
 * import os
 * from pathlib import Path             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyhuffman/backends/cython/_hfm.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyhuffman.backends.cython._hfm", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyhuffman.backends.cython._hfm");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
